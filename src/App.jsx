 ...
 {/* 
      ...
      <section id="productos-recomendados" className="features-section recommended-section">
        <div className="section-title">
          ...
          <p>Domina los oficios más lucrativos y demandados del mercado actual. Elige tu curso, estudia a tu propio ritmo y obtén tu certificación internacional. Empieza a construir tu futuro hoy mismo.<h5>"Tu inversión está 100% protegida con nuestra garantía de satisfacción."</h5></p>
        </div>
